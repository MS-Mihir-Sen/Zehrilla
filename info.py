...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/+jg74vZvDiY9iNjA1')
...
URL = "https://radhe-krishn-bnvm.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://radhe-krishn-bnvm.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://radhe-krishn-bnvm.onrender.com/".format(FQDN)
else:
    URL = "https://radhe-krishn-bnvm.onrender.com/".format(FQDN)
