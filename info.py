...
URL = "https://radhe-krishn-axon.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://radhe-krishn-axon.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://radhe-krishn-axon.onrender.com/".format(FQDN)
else:
    URL = "https://radhe-krishn-axon.onrender.com/".format(FQDN)
